...
- Notion databases for: contacts/CRM, project tasks, content calendar
- Synced with Drive/GitHub via Zapier where it makes sense

### Dropbox (future)
- Pure backup mirror of Google Drive's Preposterous folder
- No unique content lives only in Dropbox
- Set up automatic sync once installed

---

## MIGRATION MAP — WHERE CURRENT FILES GO

Based on the ClawBot Zero diagnostic (April 11, 2026):

| Current Location | Destination | Notes |
|---|---|---|
| OneDrive/Documents/FULLOFIT INDUSTRIES/ | Split: docs → `02-storylivingry-studio/`, video → `07-media-assets/video/` | 22.2 GB — biggest migration task |
| OneDrive/Documents/MENTAL WEALTH/ | `01-mental-wealth/` | Direct move |
| OneDrive/Documents/Maia Lotus Foundation/ | `01-mental-wealth/` or `06-archive/` | Confirm with Bret |
| OneDrive/Documents/psychepath-project/ | `01-mental-wealth/slaas/` or `02-storylivingry-studio/` | Delete duplicate in Downloads |
| OneDrive/Documents/METTA BONFIRE/ | `02-storylivingry-studio/noosphere/` | Bot/agent infrastructure |
| OneDrive/Documents/Realization Labs Cowork Claude/ | `04-realization-labs/cowork/` | Direct move |
| OneDrive/Documents/Biz Plans/ | `05-operations/biz-plans/` | Direct move |
| OneDrive/Documents/CV/ | `05-operations/cv-and-bio/` | Direct move |
| OneDrive/Documents/Decks/ | `05-operations/decks/` | Direct move |
| OneDrive/Documents/THE SHASTA CHRONICLES/ | `02-storylivingry-studio/` or `06-archive/` | Confirm with Bret |
| OneDrive/Documents/Together UFO/ | Confirm with Bret | Need context |
| OneDrive/Documents/Screenshots/ | `07-media-assets/screenshots/` | 2.5 GB of video in here too |
| OneDrive/Documents/Janet/ + Janet - Copy/ | `07-media-assets/video/personal/` | Delete the copy (4 GB saved) |
| OneDrive/Documents/CRYSTAL TG exports (x3)/ | Keep one → `06-archive/telegram-export/`, delete 2 copies | 1.8 GB saved |
| OneDrive/Documents/Bret Session Audio Files/ + copy | Keep one → `07-media-assets/audio/`, delete copy | |
| Downloads/SXMVP.zip | Evaluate, then `06-archive/` or delete | 1.76 GB |
| Downloads/JanetMaryFulpPt1.mp4 | `07-media-assets/video/personal/` | 1.29 GB |
| D: drive (Samsung phone dump) | `07-media-assets/video/raw-footage/` and `07-media-assets/photos/` | 39.7 GB total, mostly MVParty footage |
| Mandelbret Storylivingry Studio (Drive) | Decompose into proper locations in Preposterous | Then delete the folder |
| 5 empty folders in Documents | Delete | |
| Clipchamp caches (~12 GB) | Clear | Not files, just cache |

---

## WHAT THIS ENABLES

Once the Preposterous ontology is in place:
- **Any new file has an obvious home** — no more dumping things on Desktop or in Documents
- **Any file can be found in seconds** — consistent naming + logical hierarchy = searchability
- **ClawBots can operate autonomously** — they know where things go because the structure is deterministic
- **Cross-pillar connections are visible** — `05-operations/outreach/` serves all pillars, `07-media-assets/` is referenced by all pillars
- **The system scales** — new sub-projects just get a new subfolder in the right pillar
- **Backup is trivial** — Dropbox mirrors the Preposterous folder, done

---

## REVISION HISTORY

- **April 11, 2026** — Created. The Preposterous Ontology is born. Root folder named by Bret Warshawsky because of course it is.
